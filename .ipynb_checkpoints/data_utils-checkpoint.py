...
class TextAudioSpeakerLoader(torch.utils.data.Dataset):
    ...
    def _filter(self):
        ...
        print("----------------------------------------")
        print("==> NUM OF SAMPLE FOR TRAINING: ", len(audiopaths_sid_text_new))
        print("----------------------------------------")
    ...
    def get_audio(self, filename):
        ...
        n_fft = 1024
        frame_shift_ms = None
        audio_norm = audio.trim_silence(audio_norm, n_fft, self.sampling_rate, self.hop_length, frame_shift_ms)
        silence = np.zeros(1 * audio.get_hop_size(self.sampling_rate, self.hop_length, frame_shift_ms))
